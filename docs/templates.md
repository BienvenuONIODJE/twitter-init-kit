...
twitter-Kit templates provide a structured starting point for product-market-fit discovery projects using AI coding agents. Templates are automatically downloaded when you run `twitter init`, but can also be downloaded manually from [GitHub Releases](https://github.com/agentii-ai/twitter-kit/releases).
...
└── .{agent}/                      # Agent-specific directory
    ...
    │   ├── twitterkit.specify.md     # /twitterkit.specify command
    │   ├── twitterkit.plan.md        # /twitterkit.plan command
    │   ├── twitterkit.tasks.md       # /twitterkit.tasks command
    │   ├── twitterkit.implement.md   # /twitterkit.implement command
    │   ├── twitterkit.clarify.md     # /twitterkit.clarify command
    │   ├── twitterkit.analyze.md     # /twitterkit.analyze command
    │   ├── twitterkit.checklist.md   # /twitterkit.checklist command
    │   ├── twitterkit.taskstoissues.md # /twitterkit.taskstoissues command
    │   └── twitterkit.constitution.md  # /twitterkit.constitution command
...
**Purpose**: Create or update your twitter specification from a natural language description

**Usage**: `/twitterkit.specify "Add user authentication to the SaaS dashboard"`
...
**Usage**: `/twitterkit.clarify` (in a conversation with your specification)
...
**Usage**: `/twitterkit.plan` (in a conversation with your specification)
...
**Usage**: `/twitterkit.tasks` (in a conversation with your plan)
...
**Usage**: `/twitterkit.implement` (ready to execute your tasks)
...
### /twitterkit.clarify (Targeted)

**Purpose**: Ask specific clarification questions about underspecified areas

**Usage**: `/twitterkit.clarify` (in a specification context)
...
**Usage**: `/twitterkit.checklist "customer interviews"` or `/twitterkit.checklist`
...
### /twitterkit.taskstoissues

**Purpose**: Convert your research tasks into GitHub issues

**Usage**: `/twitterkit.taskstoissues`
...
**Usage**: `/twitterkit.constitution` or `/twitterkit.constitution "add principle"`

**Enables**:
- View base twitter-Kit constitution
...
- **Invocation**: `/twitterkit.specify "your request"`
...
**Initial Release**: twitter-Kit v0.1.0 introduces automated template generation for 18 AI agents (36 variants total).

**Includes**:
- twitter-Kit Constitution v1.0.0
- 9 core slash commands
- Templates for spec, plan, and tasks
- Support for bash and PowerShell

**Download**: [twitter-Kit v0.1.0 Release](https://github.com/agentii-ai/twitter-kit/releases/tag/v0.1.0)

## Manual Template Download

If you prefer to manually manage templates:

1. Go to [GitHub Releases](https://github.com/agentii-ai/twitter-kit/releases)
...
- **Issues**: [GitHub Issues](https://github.com/agentii-ai/twitter-kit/issues)
- **Discussions**: [GitHub Discussions](https://github.com/agentii-ai/twitter-kit/discussions)
- **Documentation**: [twitter-Kit Docs](https://github.com/agentii-ai/twitter-kit#-reference-documentation)

## Contributing

We welcome contributions to improve twitter-Kit templates:
