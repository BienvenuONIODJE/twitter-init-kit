...
- Use the `/twitterkit.` command prefix to easily discover Spec Kit-related commands.
...
- All command files now prefixed with `twitterkit.` (e.g., `twitterkit.twitter.md`, `twitterkit.plan.md`) for better discoverability and differentiation in IDE/CLI command palettes and file explorers
